...
public class Filter {
    public static void main(String[] args) {
        ...
        laptops.add (new Laptop ("DELL", "763456743")); // заполнение с помощью конструктрора класса
        ...
        for (Laptop laptop : laptops) {
            if (!laptop.getProducer().equals(producer))  // пропустить, если неправильный производитель
                continue;
            if (!laptop.getModel().startsWith("6"))  // пропустить, если стартует с 6 - неправильная модель
                continue;
